...
<body>
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm rounded-3 sticky-top" style="top: 100px;">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex flex-row flex-md-column align-items-center text-md-center mb-4 position-relative">
                            <div class="flex-shrink-0 mb-md-3 me-3 me-md-0 border border-2 border-white shadow-sm rounded-circle overflow-hidden" style="width: 80px; height: 80px;">
                                @if($customer->foto)
                                    <img src="{{ asset('uploads/' . $customer->foto) }}" alt="Avatar" class="avatar-img">
                                @else
                                    <img src="https://ui-avatars.com/api/?name={{ urlencode($customer->nama_lengkap) }}&background=374151&color=fff&size=128" alt="Avatar" class="avatar-img">
                                @endif
                            </div>
                            ...
                            <button class="btn btn-link text-secondary p-0 position-absolute top-0 end-0 d-md-none" onclick="triggerTab('v-pills-edit-tab')">
                                <i class="bi bi-pencil-square fs-5"></i>
                                <span class="d-block" style="font-size: 10px;">Edit</span>
                            </button>
                        </div>

                        <button class="btn btn-custom-green w-100 mb-4 d-none d-md-block py-2 fw-medium btn-sm shadow-sm" onclick="triggerTab('v-pills-edit-tab')">
                            Edit Data Diri
                        </button>
                        ...
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <button class="nav-link active mb-2" id="v-pills-history-tab" data-bs-toggle="pill" data-bs-target="#v-pills-history" type="button" role="tab">
                                <div class="icon-box"><i class="bi bi-clock-history small"></i></div>
                                <span class="small">Riwayat Pesanan</span>
                            </button>

                            <button class="nav-link mb-2" id="v-pills-address-tab" data-bs-toggle="pill" data-bs-target="#v-pills-address" type="button" role="tab">
                            ...
                            <button class="nav-link d-none" id="v-pills-edit-tab" data-bs-toggle="pill" data-bs-target="#v-pills-edit" type="button" role="tab">
                                Edit
                            </button>
                        </div>
    ...
    <script>
        // Helper function untuk memicu tab secara manual (misal dari tombol Edit)
